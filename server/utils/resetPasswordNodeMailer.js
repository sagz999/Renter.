...
function resetPasswordMailOTP(userEmail) {
  ...
  let emailBody = ` <div>
    <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
        <div style="margin:50px auto;width:70%;padding:20px 0">
            ...
            <p>Thank you for choosing Renter. Use the following OTP to reset your password. OTP is valid for 5 minutes</p>
...
module.exports = resetPasswordMailOTP;
